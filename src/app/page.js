...
export default function Home() {
  return (
    ...
    <div className="bg-white">
      ...
      <div className="hero bg-gradient-to-r  from-yellow-200 via-yellow-100 to-yellow-300">
<section id="journey">
      ...
      <Image src="/profile.jpg" width="300" height="100" alt="profile" className="md:w-70 w-65 z-[0]"></Image>
        ...
        <p className="font-sans font-medium mt-2 md:text-md lg:text-lg">She is Blessed soul and having super Natural power of Healings and Psychic senses which is directly given by the universe. She has the blessing of the <span className="bg-orange-300 p-1">MAHADEV🙏and MAA KALI on her.</span> <br/>
        She has started her Spritual journey on 2022 where some unfavorable incident happend in her life and she started her journey to find the questions going on her mind. Sooner she has felt the divine connections with universe where her Grandfather spirit helps to follow the path of our <span className="bg-orange-300">DIVINE FATHER. MAHADEV </span>and she begins to follow the guidances given by her spirit guide/Angles her Grandfather.<br></br> He guided her in every single step of her spiritual journey and later she know about her spiritual gifts .MAHADEV BLESSED her with unlock the power of <span className="bg-orange-300">MAHAMRITUNJAYA MANTRA.</span><br/> MAA KALI BLESSED her with divine Spiritual gifts of speaking with Spirits in Heavens as well as in earth and blessed her with the unlock vibrations of Beej mantra of MAA KALI It's an adventurous journey. You are also able those part of life with the help of Nehaa jain energies.You are able to go transparent where your soul memories has ariesd and you able to see past life vision very clear.</p>
        </div>
