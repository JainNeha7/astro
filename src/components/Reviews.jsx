...
const data=[
    {
        ...
        rating: 4.5,
        date: "2024-05-15",
        review: "Great product! Met all my expectations and more. Highly recommend to anyone looking for quality and reliability."
      },
      {
        reviewer: "John Doe",
        rating: 4.5,
