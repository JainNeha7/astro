...
<div className="hero pt-4 bg-base-200">
  <div className="hero-content  flex-col  lg:flex-row-reverse">
    ...
    <img src="/about.png" className="max-w-md z-0 relative lg:-mt-40 md:max-w-lg md:ml-2  mb-2 rounded-lg shadow-2xl" />
    </div>
    <div>
     ...
     <p className="py-4 text-sm md:text-md ">At cozzmo By Neha, we offer a variety of services tailored to your spiritual needs:</p>
