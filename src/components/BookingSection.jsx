...
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Tarot Reading</h2>
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/soulrecord.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Soul records through akashic Records Reading</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/MEDIUMSHIP.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Mediumship</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/pastlife.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Past Life Regression Online/Offline
</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/lamafhera.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Lamafera</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/markeshhealing.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Markesh Healings</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/planetry.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Planetry Shiftings Healings</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/sadesati.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Sade sati of shani vibration shifting</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/shivsakti.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Shalvik With Shiva Healing</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/yogmaya.png" alt="card" /></figure>
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/maabaglamati.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Maa Baglamukhi healing</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/Spiritualtreatmentforconceptualpregnancy.png" alt="card" /></figure>
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/cancer.png" alt="card" /></figure>
...
<div className="card my-4 card-compact w-96 bg-base-100 shadow-2xl">
  <figure><img src="/vastuhealing.png" alt="card" /></figure>
 
  <div className="card-body ml-4">
    <div className='flex justify-between'>
<div>
    <h2 className="card-title text-2xl font-serif font-bold">Vastu healing</h2>
    <div className='border-b-4 mb-2 border-yellow-400 w-36 h-1'></div>
    <div className="rating ">
  <input type="radio" name="rating-1" className="mask mask-star" />
  <input type="radio" name="rating-1" className="mask mask-star"  />
